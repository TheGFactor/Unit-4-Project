...
public class garageIn {
    ...
    private static TicketList tix = TicketList.getInstance();
    ...
    private static void mainMenu(){
        ...
        do {
            ...
            switch(input){
                ...
                case "2": specialEvent(); proceed = false; break;
                case "3": garageReport(); proceed = false; break;
                case "4": save(); proceed = false; break;
                //case "444": debug(); proceed = false; break; //DEBUG DEBUG DEBUG
                default:
                    System.out.println("Best Value Parking Garage\n=========================\n");
    ...
    private static void checkIn(){
        ...
        int newTicket = tix.newTicket((rng.nextInt(6) + 7));
    ...
    private static void specialEvent(){
        ...
        int newTicket = tix.newTicket(-22);
        System.out.println("\n\n\nSpecial Event Ticket ID " + newTicket + " generated.\n\n\n");
        mainMenu();//Returns the user to the main menu
    }
    ...
    /**
     * This simply closes the file to be used by the other kiosk. Safely re-writes to the file.
     */
