...
public class garageOut {
    ...
    private static void checkOut(){
        ...
        do {
            ...
            input = in.nextLine();
            int[] data = tix.checkOut(Integer.parseInt(input), (rng.nextInt(11) + 1));
            if(data[0] == -1){
                System.out.println("Best Value Parking Garage\n=========================\n");
    ...
    private static void mainMenu(){
        ...
        do {
            ...
            switch(input){
                ...
                case "3": save(); proceed = false; break;
                default:
                    System.out.println("Best Value Parking Garage\n=========================\n");
    ...
    private static void lostTix(){
        ...
        do {
            ...
            System.out.println("Please enter in a ticket number.");
            input = in.nextLine();
            int data = tix.lostTix(Integer.parseInt(input));
            if(data == -1){
                System.out.println("Best Value Parking Garage\n=========================\n");
                System.out.println("Ticket not found. Please enter a valid ticket number.");
                proceed = true;
